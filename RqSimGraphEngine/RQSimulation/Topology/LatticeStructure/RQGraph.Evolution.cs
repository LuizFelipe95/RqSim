...
namespace RQSimulation
{
    ...
    public partial class RQGraph
    {
        ...
        public void QuantumGraphityStep()
        {
            ...
            bool shouldUpdateTopology = Physics.TimeManager.ShouldUpdateTopology(
                _quantumGraphityStepCount,
                PhysicsConstants.TopologyDecoherenceInterval);
            ...
            if (shouldUpdateTopology)
            {
                ...
                for (int s = 0; s < steps; s++)
                {
                    // RQ-HYPOTHESIS CHECKLIST FIX #6: Adaptive flip probability
                    // Skip flip if edge has high quantum amplitude (coherence protection)
                    if (PhysicsConstants.EnableAdaptiveTopologyDecoherence)
                    {
        ...
        /// 
        /// RQ-HYPOTHESIS CHECKLIST FIX #6: Prevents Zeno effect by
        ...
        private bool MetropolisEdgeStepWithCoherenceCheck()
        {
            ...
            // If amplitude is high, suppress flip probability
            if (amplitudeSquared > PhysicsConstants.TopologyFlipAmplitudeThreshold)
            {
                ...
                {
                    // Flip suppressed by quantum coherence
                    return false;
                }
            }
