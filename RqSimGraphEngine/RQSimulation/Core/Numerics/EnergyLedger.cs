...
namespace RQSimulation
{
    ...
    public class EnergyLedger
    {
        ...
        {
            if (!PhysicsConstants.WheelerDeWittConstants.EnableViolationLogging)
                return;
            ...
            if (_constraintViolationHistory.Count > 10000)
            {
                _constraintViolationHistory.RemoveRange(0, 5000);
            }
        }
        ...
        /// 
        /// RQ-HYPOTHESIS CHECKLIST: Uses PhysicsConstants.InitialVacuumEnergy as default.
...
public void Initialize(double initialEnergy)
{
    ...
    _vacuumBorrowing = 0;
    // Use the larger of computed fraction or InitialVacuumEnergy from constants
...
/// 
/// RQ-HYPOTHESIS CHECKLIST: Ensures vacuum pool is at least InitialVacuumEnergy.
/// </summary>
public void Initialize(double vacuumEnergy, double matterEnergy, double fieldEnergy)
{
    // Ensure minimum vacuum energy from PhysicsConstants
