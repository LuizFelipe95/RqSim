...
namespace RQSimulation.GPUOptimized
{
    ...
    public static class OllivierRicciCurvature
    {
        ...
        /// <param name="lazyWalkAlpha">Lazy walk parameter (probability of staying at current node). Default 0.1</param>
        public static double ComputeOllivierRicci(RQGraph graph, int i, int j, double lazyWalkAlpha = 0.1)
        {
            if (!graph.Edges[i, j])
                return 0.0;
