...
partial class Form_Main
{
    ...
    /// <summary>
    /// Opens the Physics Plugin Manager dialog.
    /// </summary>
    private void ToolPluginManager_Click(object? sender, EventArgs e)
    {
        OpenPluginManager();
    }
    ...
    /// <summary>
    /// Shows plugin manager as modal dialog and returns result.
    /// </summary>
    public DialogResult ShowPluginManagerModal()
    {
        EnsurePipelineInitialized();

        var pipeline = _simApi.Pipeline;

        using var form = new PhysxPluginsForm(pipeline);
