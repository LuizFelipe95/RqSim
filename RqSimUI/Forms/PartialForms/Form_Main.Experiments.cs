...
public partial class Form_Main
{
    ...
    private void BtnExpNew_Click(object? sender, EventArgs e)
    {
        ...
        AppendSysConsole("[Experiment] New experiment created from current settings\n");
    }
    ...
    private void BtnExpApplyToSim_Click(object? sender, EventArgs e)
    {
        ...
        tabControl_Main.SelectedTab = tabPage_Settings;

        AppendSysConsole($"[Experiment] Applied '{_currentExperiment.Name}' config to Settings tab\n");
    }
    ...
    private ExperimentConfig GetCurrentConfigFromUI()
    {
        return new ExperimentConfig
        {
            ...
            UseHotStartAnnealing = true, // Always enabled - natural cooling via RQ edge creation costs
